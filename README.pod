...
=for HTML <a href="https://www.github.com/briandfoy/clockify/actions?query=workflow%3Amacos"><img src="https://www.github.com/briandfoy/clockify/workflows/macos/badge.svg"></a>

=for HTML <a href="https://www.github.com/briandfoy/clockify/actions?query=workflow%3Aubuntu"><img src="https://www.github.com/briandfoy/clockify/workflows/ubuntu/badge.svg"></a>

=for HTML <a href="https://www.github.com/briandfoy/clockify/actions?query=workflow%3Awindows"><img src="https://www.github.com/briandfoy/clockify/workflows/windows/badge.svg"></a>

=for HTML <a href='https://ci.appveyor.com/project/briandfoy/clockify'><img src='https://ci.appveyor.com/api/projects/status/vp4gr6fbnrc5erov?svg=true'></a>

=for HTML <a href='https://coveralls.io/github/briandfoy/clockify?branch=master'><img src='https://coveralls.io/repos/github/briandfoy/clockify/badge.svg?branch=master' alt='Coverage Status' /></a>

=for HTML <a href="https://github.com/briandfoy/clockify/blob/master/LICENSE"><img src="https://img.shields.io/cpan/l/Clockify.svg" /></a>

=for HTML <a href="https://metacpan.org/pod/Clockify"><img src="https://img.shields.io/cpan/v/Clockify.svg" /></A>

=head1 The Clockify module

This is the I<README> for the L<Clockify> Perl module.
...
To read about L<Clockify>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/Clockify.pm
...
L<MetaCPAN|http://www.metacpan.org/module/Clockify>.
...
the source repository: L<https://github.com/briandfoy/clockify>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/clockify/issues>.
...
=item * L<https://bitbucket.com/briandfoy/clockify>

=item * L<https://codeberg.org/briandfoy/clockify>

=item * L<https://gitlab.com/briandfoy/clockify>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify Clockify-1.23.tar.gz --owner briandfoy
